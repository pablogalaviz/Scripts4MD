#!/bin/sh
#SBATCH --job-name=SiO2_amo_reaxff_2nm_pore   # Job name
...
# -----Executing command:
srun -u -N $SLURM_JOB_NUM_NODES -n $SLURM_NTASKS -c $OMP_NUM_THREADS lmp -k on -sf kk -pk kokkos -in in.lammps -nocite -log results/lammps.log
