...
# Add solvate
echo q | $GMX_CMD make_ndx -f gro/pore.gro -o ndx/index.ndx
...
#Energy minimization
(
$GMX_CMD grompp -f ./mdp/min.mdp -c ./gro/pore.gro -r ./gro/pore.gro -p ./top/topol.top -o ./min/input.tpr -po ./min/mdout.mdp -n ./ndx/index.ndx -maxwarn $MAXWARN
