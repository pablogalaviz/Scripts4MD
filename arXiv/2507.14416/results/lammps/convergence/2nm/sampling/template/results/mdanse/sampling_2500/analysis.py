...
for temperature in [100]:
    ...
    convert("nvt_phonon",temperature,n_steps=2500)
    dos(temperature)
    msd(temperature,frames=(0, 10000, 4))
    rmsd(temperature,frames=(0, 10000, 4))
    rmsf(temperature,frames=(0, 10000, 4))
    rog(temperature,frames=(0, 10000, 4))
    ecc(temperature,frames=(0, 10000, 4))
