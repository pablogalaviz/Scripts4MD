...
for temperature in [100]:
    ...
    convert("nvt_phonon",temperature,n_steps=1250)
    dos(temperature)
    msd(temperature,frames=(0, 10000, 8))
    rmsd(temperature,frames=(0, 10000, 8))
    rmsf(temperature,frames=(0, 10000, 8))
    rog(temperature,frames=(0, 10000, 8))
    ecc(temperature,frames=(0, 10000, 8))
